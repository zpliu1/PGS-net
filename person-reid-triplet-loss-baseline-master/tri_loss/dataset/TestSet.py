...
class TestSet(Dataset):
  ...
  def get_sample(self, ptr):
    ...
    im, _ = self.pre_process_im.test_pre_process_im(im)
  ...
  def extract_feat(self, normalize_feat, verbose=True):
    ...
    """
    #feat, ids, cams, im_names, marks, ims, yy1, yy2, yy3, yy4, yy5, yy6, yy7, yy8, yy9, yy10, xx , mm1, mm2, mm3, mm4, mm5, mm6, mm7, mm8, mm9, mm10,yyy= [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [],[], [], [], [], [], [], [], [], [], [],[]
    feat, ids, cams, im_names, marks, ims= [], [], [], [], [], []
    done = False
    step = 0
    printed = False
    st = time.time()
    ...
    while not done:
      ...
      #feat_ , yy1_, yy2_, yy3_, yy4_, yy5_, yy6_, yy7_, yy8_, yy9_, yy10_, xx_, mm1_, mm2_, mm3_, mm4_, mm5_, mm6_, mm7_, mm8_, mm9_, mm10_,yyy_= self.extract_feat_func(ims_)
      ...
      '''
      #result_ims = {'ims': ims_}
      #scipy.io.savemat('result_ims.mat', result_ims)
    ...
    #result_y = {'yy1': yy1, 'yy2': yy2, 'yy3': yy3, 'yy4': yy4, 'yy5': yy5, 'yy6': yy6, 'yy7': yy7, 'yy8': yy8, 'yy9': yy9, 'yy10': yy10, 'xx': xx,'mm1':mm1, 'mm2':mm2,'mm3':mm3,'mm4':mm4,'mm5':mm5,'mm6':mm6,'mm7':mm7,'mm8':mm8,'mm9':mm9,'mm10':mm10, 'yyy':yyy}
    #scipy.io.savemat('result_y.mat', result_y)
  ...
  def eval(
    ...
    result = {'gallery_f': feat[g_inds], 'gallery_label': ids[g_inds], 'gallery_cam': cams[g_inds],
              'query_f': feat[q_inds], 'query_label': ids[q_inds], 'query_cam': cams[q_inds]}
    scipy.io.savemat('pytorch_result.mat', result)

    #result1 = {'mquery_f': global_feats[mq_inds].numpy(), 'mquery_label': ids[mq_inds], 'mquery_cam': cams[mq_inds]}
    #scipy.io.savemat('multi_query.mat', result1)
