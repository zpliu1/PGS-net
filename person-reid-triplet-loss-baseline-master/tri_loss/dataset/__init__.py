...
def create_dataset(
  ...
  if name == 'market1501':
    ...
    #im_dir = ospeu('/E/lzp/shuju/images')
    #partition_file = ospeu('/E/lzp/shuju/partitions.pkl')
    im_dir = ospeu('/home/zhang/E/lzp/shuju/images')
    partition_file = ospeu('/home/zhang/E/lzp/shuju/partitions.pkl')
  elif name == 'cuhk03':
    im_type = ['detected', 'labeled'][1]
    im_dir = ospeu(ospj('/home/zhang/E/lzp/cuhk_shuju', im_type, 'images'))
    partition_file = ospeu(ospj('/home/zhang/E/lzp/cuhk_shuju', im_type, 'partitions.pkl'))
